                ...
                <section className='pt-10'>
                  <form className='flex justify-center items-center md:gap-4 w-full  '>
                    ...
                    <div className='px-4 py-2 w-[60vw] md:w-[40vw] rounded-full  gap-2 border border-[#86868673] bg-[#171615A6] outline-[#48B96B] flex items-center'>
                      <span><MdSearch className='text-[#EAF5F440] text-xl' /></span>
                      <input type='email' placeholder='Search for courses...' className='w-[60vw] md:w-[40vw] placeholder:text-[#EAF5F440] placeholder:text-md placeholder:font-inter placeholder:font-[400]  outline-none' />
                  </div>
