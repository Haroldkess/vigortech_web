  ...
  return (
    <>
      <section className="overflow-x-hidden">
            ...
            <section className=" space-y-4 ">
              ...
              <section className="flex flex-col items-center gap-4  justify-center w-[90vw] md:w-full ">
                ...
                <section className=" flex flex-col md:flex-row gap-4 ">
                  <section className=" flex w-[90vw] md:w-[185px]  justify-center items-center">
                    <Link href={"/contact-us"} className="w-full">
                      <button className=" group border border-[#48B96B] h-[48px]  w-full md:py-4 font-normal justify-center rounded-md flex items-center gap-2 transition-colors duration-100 hover:bg-[#6CC78840]  hover:text-white">
                        Get in touch{" "}
        ...
        <section className="pt-[100px] bg-[#171615A6] gap-y-10 flex flex-col rounded-t-2xl  z-20 border-t border-black/5 w-full relative top-[-16rem] md:top-[-15rem]">
          <TechSection />
