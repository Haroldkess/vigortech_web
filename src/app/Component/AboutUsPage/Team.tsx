        ...
        <div className=" text-white min-h-screen flex flex-col items-center justify-center px-4 py-12">
            <div className="text-center max-w-4xl w-full">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-5xl mx-auto mb-12 ">
                    <TeamCard imageSrc="/Teams/co-founder.png" name="Harold Osuji" role="Co-Founder" />
                    <TeamCard imageSrc="/Teams/VA.png" name="Agu Precious" role="Virtual Assistant" />
                    <TeamCard imageSrc="/Teams/cto.png" name="Onomuefor Nelson" role="CTO" />
                </div>


                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-xl mx-auto mb-12">
                    <TeamCard imageSrc="/Teams/QA.png" name="Boi Uche" role="QA Engineer" />
                    <TeamCard imageSrc="/Teams/PD.png" name="Coleman Osuji" role="Product Designer" />
                </div>
