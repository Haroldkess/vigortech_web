      ...
      <div className="text-center max-w-4xl w-full">
        ...
        <div className="flex justify-center">
          <button
            ...
            className="group border border-[#48B96B] lg:w-[198px] w-full py-[12px] md:w-[185px] md:h-[48px] font-normal justify-center rounded-md flex items-center gap-2 transition-colors duration-100 hover:bg-[#6CC78840]  hover:text-white"
          >
            Join the team
