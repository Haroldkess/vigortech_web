  ...
  return (
    <section className=" w-full px-4 md:mx-auto  md:px-6  flex flex-col  items-center md:flex-row md:justify-center md:items-center gap-12 md:gap-0">
      <div
        ...
        ref={ref}
      >
        <section className="flex flex-col md:flex-row justify-center items-center gap-x-20">
          <div className="md:w-[4vw] w-[12vw]">
            <h3 className="text-3xl md:text-5xl font-semibold border-b border-gray-600 pb-1 md:w-[4vw] w-[12vw]">
              {inView ? <CountUp start={0} end={5} duration={4} /> : "0"}+
            </h3>
            <p className="text-[#EAF5F4A6] mt-1 text-base font-normal">
              Projects
            </p>
          </div>
