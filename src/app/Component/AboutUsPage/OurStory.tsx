    ...
    return (
        <section>
            <section className='flex  justify-between w-full py-20 px-20 relative gap-10'>
                ...
                <section>
                    <section className='absolute bottom-[-3em] left-10'>
                        <Image src={'/Earth.png'} alt='sise image 1' width={670} height={670} className='' />
                    </section>
                    <section className='absolute bottom-[-4em] left-[-6em] -z-[4em] blur-2xl'>
                        <Image src={'/bgEarth.png'} alt='sise image 1' width={700} height={700} className='' />
                    </section>
                <section className="absolute bottom-24 left-[23em] z-50 ">
