...
export default function NewsLetter() {
    return (
        <section className=' flex justify-center items-center w-full pb-10 md:pb-20 flex-col relative' >
            <section>
                <Image src="/newsLetterBg.svg" alt="Newsletter Image" width={2000} height={2000} className='backdrop-blur-md  object-cover h-[40vh] md:h-[60vh] w-[100vw] mt-20 rounded-t-2xl' />
            </section>
