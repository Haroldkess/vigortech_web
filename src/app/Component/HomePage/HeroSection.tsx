          ...
          >
            ...
            <section>
              <section className=" flex flex-col md:flex-row gap-4 w-[90vw]">
                ...
                <button className="group border border-[#48B96B] w-[357px] py-[12px] md:w-[185px] md:h-[48px] font-semibold justify-center rounded-md flex items-center gap-2 transition-colors duration-100 hover:bg-[#6CC78840]  hover:text-white">
                  Get in touch
